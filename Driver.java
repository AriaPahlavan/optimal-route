    ...
    public static void main(String[] args) throws Exception {
        ...
        if (testGraph.getNumPorts() < 20) {
            ...
            for (int i = 0; i < testGraph.getNumPorts(); i++) {
                System.out.println(i + ": " + testGraph.getNeighborsStr(i));
            }
        }
...
*/
        ...
        String[] files = {"3", "5", "10", "500", "1000", "2000"};
        for (String file : files) {

            parseInputFile("example_input/" + file);
            int sourcePort = 0;
            int destPort = testGraph.getNumPorts() - 1;

            System.out.print(testGraph.findTimeOptimalPath(sourcePort, destPort) + " - ");
            System.out.println(testGraph.findCapOptimalPath(sourcePort, destPort));
        }
    }
